...
type DocInsertAquilaDatabase struct {
}

func NewDocInsertAquilaDatabase(wallet *WalletStruct) *DocInsertAquilaDatabase {
	return &DocInsertAquilaDatabase{}
}

// Send row html to mercury to parse
// in response will be json.
// We need take url and content field
func (d *DocInsertAquilaDatabase) SendHTMLForParsingToMercury(mercuryRequest *MercuryRequestStruct, url string) (*MercuryResponseStruct, error) {
...
func (d *DocInsertAquilaDatabase) SendContentToTxPick(txPickRequest *TxPickRequestStruct, url string) (*TxPickResponseStruct, error) {
...
func (d *DocInsertAquilaDatabase) SendTextToAquilaHub(a *AquilaHubRequestStruct, url string) (*AquilaHubResponseStruct, error) {
...
func (d *DocInsertAquilaDatabase) SendVectors(docInsert *DocInsertRequestStruct, url string) (*DocInsertResponseStruct, error) {
